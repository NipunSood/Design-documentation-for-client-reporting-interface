...
data.forEach(clientTransactions => {
    ClientData[clientTransactions.client_name]=clientTransactions.amount_invested;
    ClientCurrentData[clientTransactions.client_name]=clientTransactions.current_value;
    ...
    for(i in ClientCurrentData){
  	...
  	var chart = new CanvasJS.Chart("chartContainer", {
		title:{
			text: "Total Amount Invested By Clients"              
		},
		data: [              
		{
...
$(document).ready(function () {
    ...
    function (json) {
        ...
        for (var i = 0; i < json.length; i++) {
            tr = $('<tr/>');
            tr.append("<td bgcolor='#D7E6FF'>" + json[i].client_name + "</td>");
